...
AS $$
DECLARE
  project_url TEXT := 'https://yipjtlkrmtkdvcxpsmvo.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InlpcGp0bGtybXRrZHZjeHBzbXZvIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2MDU5MDE3MiwiZXhwIjoyMDc2MTY2MTcyfQ.JgEUbElFO065M8y3y8zeokKXgYLG_to66D8OMQeG5zM'; -- full access needed for http request to storage
